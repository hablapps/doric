...
trait FromDfExtras {
  ...
  def col[T: FromDf](colName: String)(implicit location: Location): DoricColumn[T] =
  ...
  def colString(colName: String)(implicit location: Location): DoricColumn[String] = {
    FromDf[String].validate(colName)
  }

  def colTimestamp(colName: String)(implicit location: Location): DoricColumn[Timestamp] =
  ...
  def colArray[T: FromDf](colName: String)(implicit location: Location): DoricColumn[Array[T]] =
    FromDf[Array[T]].validate(colName)

  def colArrayInt(colName: String)(implicit location: Location): DoricColumn[Array[Int]] =
    FromDf[Array[Int]].validate(colName)

  def colArrayString(colName: String)(implicit location: Location): DoricColumn[Array[String]] =
