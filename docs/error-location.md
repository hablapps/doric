...
//   Kleisli(doric.types.SparkType$$Lambda$2284/637724510@36e9794c),
//   "str"
// )
val col2 = colString(c"int")
// col2: NamedDoricColumn[String] = NamedDoricColumn(
//   Kleisli(doric.types.SparkType$$Lambda$2284/637724510@a4388f1),
//   "int"
// )
val col3 = colInt(c"unknown")
// col3: NamedDoricColumn[Int] = NamedDoricColumn(
//   Kleisli(doric.types.SparkType$$Lambda$2284/637724510@3687b83c),
//   "unknown"
// )
```
```scala
...
//   Kleisli(doric.types.SparkType$$Lambda$2284/637724510@2703785e),
//   "name_user"
// )
colInt(c"age_user")
// res3: NamedDoricColumn[Int] = NamedDoricColumn(
//   Kleisli(doric.types.SparkType$$Lambda$2284/637724510@3a7f382),
//   "age_user"
// )
colString(c"city_user")
// res4: NamedDoricColumn[String] = NamedDoricColumn(
//   Kleisli(doric.types.SparkType$$Lambda$2284/637724510@5a2297d7),
//   "city_user"
// )
```
