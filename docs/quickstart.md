...
* The latest experimental version of doric is 0.0.0+1-81a576d0-SNAPSHOT.
...
// 'Project [unresolvedalias((value#365 * true), Some(org.apache.spark.sql.Column$$Lambda$5128/0x0000000801bca840@c3a39f))]
...
//   'Project [unresolvedalias((cast(str#378 as double) + true), Some(org.apache.spark.sql.Column$$Lambda$5128/0x0000000801bca840@c3a39f))]
