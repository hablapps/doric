...
trait CommonColumns extends ColGetters[DoricColumn] {
  ...
  implicit class SparkCol(private val column: Column) {
    ...
    /**
      ...
      * @param location the location if there is a error
      * @tparam T The expected type that should have the column.
      * @return A DoricColumn referece of the provided type T
      */
  ...
  implicit class BasicCol[T: SparkType](private val column: DoricColumn[T]) {
    ...
    /**
      ...
      * @param colName the alias to set the column.
      * @return DoricColumn with the alias
      */
    ...
    /**
      ...
      * @return a reference to a Boolean DoricColumn whit the comparation
      */
    ...
    /**
      ...
      * @param f the function to apply to the column.
      * @tparam O the returning type
      * @return the DoricColumn reference with of the provided logic
      */
    ...
    /**
      ...
      * @return the DoricColumn of the provided type.
      */
    def cast[To: CastToT: SparkType]: DoricColumn[To] =
      Casting[T, To].cast(column)

    /**
      * Allows to cast to posible wrong or with unexpected behaviour type,
      * like casting String to Int, that can be resulted in null types.
      * @tparam To the type to cast to.
      * @return the DoricColumn of the provided type
      */
    ...
    /**
      ...
      * @param elems literals to compare to
      * @return Boolean DoricColumn with the comparation logic.
      */
    def isIn(elems: T*): BooleanColumn = column.elem.map(_.isin(elems: _*)).toDC

    /**
      * Checks if the value of the column is null
      * @return Boolean DoricColumn
      */
